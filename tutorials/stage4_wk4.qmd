...
- Give each student a copy of the project timeline. T
...
- The dates on the left are the *beginnings* of each week, and the events might be later in that week (e.g. the PSYC601 deadline is actually Friday 31st October).
...
***The timeline is here***: [Stage 4 _tutorial_dissertation_timeline.pdf](../docs/Stage 4 _tutorial_dissertation_timeline.pdf)
