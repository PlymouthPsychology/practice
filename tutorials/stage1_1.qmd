...
- Where are the differences between groups? Are they big enough to matter?  What do we mean by "matter"? How can we judge? Aim is to highlight that the effect size is what we care about. Contrast: we could be _very_ sure about a tiny (and irrelevant) effect.

- Why might there be a difference, conceptual > factual? Can they think of topics from A-level which might be relevant here? In the UK syllabus they _might_ have covered:
...
- What else would _they_ want to know to make a decision?
