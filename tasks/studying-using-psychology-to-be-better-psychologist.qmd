...
subtitle: "Should we make notes in lectures by hand or using a laptop?"
author: Sean Fallon
...
Please read the extract below from [Mueller & Oppenheimer (2014)](https://journals.sagepub.com/doi/abs/10.1177/0956797614524581), which describes a study conducted in 2014:
...
2. Reflect on what the study tells us, and how it might influence what you do in lectures. In particular, you might like to consider these questions:
...
[Show your work to Psybot](https://psybot.llemma.net/add/){.submit-work .btn .btn-primary}
