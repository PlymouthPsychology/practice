...
![](../images/DALL·E 2024-07-16 10.34.06 - A scientific scene on Mars with evidence of porcine life, such as pigs walking around the Martian landscape. The setting should look like a futuristic.webp)
...
> **Problem**: The sentence is missing a full stop to separate two different ideas.
...
<button id="copy-button" class="float-end btn btn-sm btn-success">Copy Text</button>
...
[Record your work here](psy){.submit-work .btn .btn-primary}
