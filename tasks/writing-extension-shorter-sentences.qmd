...
In the [original concise-writing task](writing-concisely.html) we introduced a number of strategies
to ensure that your writing is clear and concise. This activity provides additional practice at writing concisely for students who find it useful.
...
<button class="copy mb-4 btn btn-outline-primary" data-clipboard-target="#examples">Copy examples</button>
